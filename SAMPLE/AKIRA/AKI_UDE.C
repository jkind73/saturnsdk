...
ATTR attribute_te_l_ak750[] = {
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(31, 26, 22), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(31, 26, 22), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(31, 26, 22), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(31, 26, 22), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(31, 26, 22), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
...
VECTOR	vector_te_l_ak750[sizeof(point_te_l_ak750) / sizeof(POINT)];
...
VECTOR	vector_yubi_l_ak750[sizeof(point_yubi_l_ak750) / sizeof(POINT)];
...
VECTOR	vector_oyubi_l_ak750[sizeof(point_oyubi_l_ak750) / sizeof(POINT)];

XPDATA AKI_OYAYUBI_L = {
...
VECTOR	vector_te_r_ak750[sizeof(point_te_r_ak750) / sizeof(POINT)];
...
VECTOR	vector_yubi_r_ak750[sizeof(point_yubi_r_ak750) / sizeof(POINT)];
...
VECTOR	vector_oyubi_r_ak750[sizeof(point_oyubi_r_ak750) / sizeof(POINT)];

XPDATA AKI_OYAYUBI_R = {
...
ATTR attribute_ude_l_ak750[] = {
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(19,  0,  0), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(19,  0,  0), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(19,  0,  0), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(31, 26, 22), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
	ATTRIBUTE(Single_Plane, SORT_CEN, No_Texture, C_RGB(31, 26, 22), 0, MESHoff|CL_Gouraud, sprPolygon, UseGouraud),
...
VECTOR	vector_ude_l_ak750[sizeof(point_ude_l_ak750) / sizeof(POINT)];
...
VECTOR	vector_ude_r_ak750[sizeof(point_ude_r_ak750) / sizeof(POINT)];
